        ...
        <div class="centered">
            ...
            <div class="navigatebtn">
                <span class="navbtn">
                    ...
                    <a href="purchase_course.php"><button button style="font-weight: bold; background-color: #5dacbd;  font-size: 16px; padding: 19px 40px; border-radius: 4px; border: 2px solid #000000;">Create new course</button></a>
                    <a href="make_appointment.php"><button button style="font-weight: bold; background-color: #5dacbd;  font-size: 16px; padding: 19px 40px; border-radius: 4px; border: 2px solid #050505;">Check appointment</button></a>
